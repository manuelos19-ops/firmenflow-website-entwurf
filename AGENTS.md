...
- **Ratgeber-Quiz-Standard:** Jeder Ratgeber-Artikel (`/ratgeber/<slug>`) MUSS zwingend ein maßgeschneidertes Wissens-Quiz unter `content/ratgeber/quizzes/<slug>.json` (Kompakt-Check 5 Fragen / Meister-Check 10 Fragen) mit dynamischer Antwort-Rotation, Lese-Tipp-Banner über dem Text und Vercel Custom Event Tracking enthalten.
