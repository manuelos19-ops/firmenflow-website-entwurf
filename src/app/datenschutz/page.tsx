      ...
      <Container className="max-w-3xl space-y-8">
        ...
        <div className="bg-white rounded-[2rem] p-8 sm:p-12 border border-[var(--color-line)] shadow-sm space-y-10 text-sm sm:text-base text-[var(--color-muted)] leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>
              <strong>Technisches Consent-Gate & Google Consent Mode v2:</strong> Das Google-Analytics-Skript (<code>gtag.js</code>) wird erst nach deiner ausdrücklichen Einwilligung im Browser nachgeladen. Vor deiner Einwilligung wird kein einziges Byte an Google übertragen. Erst wenn du im Cookie-Banner aktiv auf „Alle akzeptieren“ klickst oder in den Einstellungen die Kategorie Analyse aktivierst, wird das Skript geladen, der Status auf <code>analytics_storage: &apos;granted&apos;</code> gesetzt und Cookies erzeugt. Bei einem Widerruf werden bestehende Cookies bereinigt und der Status auf <code>denied</code> zurückgesetzt.
            </p>
            <p>
