    ...
    >
      <Container className="relative z-20">
        ...
        <div className="contact-reveal text-center max-w-3xl mx-auto mb-16 md:mb-20">
          <span className="badge-eyebrow-dark mb-6">
        ...
        {/* Quick Contact Bar - Double Bezel Architecture */}
        ...
        <div id="projektanfrage" className="contact-reveal max-w-4xl mx-auto space-y-6 scroll-mt-28">
          {/* Segmented Switcher Header - Double Bezel Architecture */}
          <div className="double-bezel-outer-dark p-1.5 rounded-[1.75rem] sm:rounded-[2.25rem] shadow-2xl">
            <div className="double-bezel-inner-dark rounded-[calc(1.75rem-0.375rem)] sm:rounded-[calc(2.25rem-0.375rem)] p-1.5 sm:p-2 grid grid-cols-1 sm:grid-cols-2 gap-2">
              {/* Tab 1: Schnell-Check */}
              <button
                type="button"
